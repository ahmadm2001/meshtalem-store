...
function InteriorDoorsContent() {
  ...
  useEffect(() => {
    productsApi.getPublic({ categoryId: INTERIOR_CATEGORY_ID, limit: 40 })
    ...
    <StoreLayout>
      ...
      <div className="relative h-64 sm:h-80 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url('/images/doors/cat-interior.jpg')" }}
        />
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <nav className="flex items-center gap-2 text-white/60 text-sm mb-4">
              ...
              <span className="text-white">דלתות פנים</span>
            </nav>
            <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight mb-2">דלתות פנים</h1>
            <p className="text-white/80 text-lg">דלתות פנים אלגנטיות לבית המודרני</p>
          </div>
        </div>
      </div>
